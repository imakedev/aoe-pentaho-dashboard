...
<script type="text/javascript">
		...
		var urlP = '<%=request.getContextPath()%>/Dashboard/CatermanQTD.jsp?y='+y+'&months='+months+'&sb='+sb; // URL Page.
		var sb = <%=sb%>;
...
"graphset":[
    {
        ...
        "series":[
            {
                "type":"bar",
                "values":[448340,390003,332640,361343],
                "text":"Net Sales",
				"stacked":0
            },
            {
                "type":"bar",
                "values":[103730,130752,127506,71488],
                "border-width":1,
                "text":"COGs",
				"stacked":0
            },
            {
                "type":"bar",
                "values":[344610,259251,205134,289855],
                "text":"Net Profit",
				"stacked":0,
                "border-width":1
            }]
 ...
 <div id="YEAR1"><font size="2" color="#000000">Year:</font>
  ...
  <div id="SUMMARYBY"><font size="2" color="#000000"> By:</font>
	<select name="SumBy" style="width:90px;" onChange="getSumBy(this.value);">
		...
		<option value="3" selected="selected">Quarter</option>
	</select> 
  </div>
