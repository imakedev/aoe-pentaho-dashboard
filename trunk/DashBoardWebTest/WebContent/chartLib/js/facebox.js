...
(function($) {
  ...
  $.extend($.facebox, {
    ...
    <div id="facebox" style="display:none;"> \
      <div class="popup"> \
        ...
        <a href="#" class="close"><img src="../chartLib/images/closelabel.png" title="close" class="close_image" /></a> \
      </div> \
    </div>'
    },
  ...
  function init(settings) {
   ...
   // alert($.facebox.settings.closeImage)
  }
  ...
  function fillFaceboxFromIframe(href, klass, height) {
	  //alert("load iframe")
	    $.facebox.reveal('<iframe scrolling="no" marginwidth="0" width="700" height="' + height + '" frameborder="0" src="' + href + '" marginheight="0"></iframe>', klass)
	 }
