...
<script type="text/javascript">
		...
		var urlP = '<%=request.getContextPath()%>/Dashboard/Caterman.jsp?y='+y+'&months='+months+'&sb='+sb; // URL Page.
		var sb = <%=sb%>;
		...
		function getSumBy(value)
		{
			sb = value;
			switch(sb){
				case '2' : urlP = '<%=request.getContextPath()%>/Dashboard/CatermanYTD.jsp?y='+y+'&months='+months+'&sb='+sb;
					break;
...
"graphset":[
    {
        ...
        "series":[
            {
                "type":"bar",
                "values":[18424,25494,7267,14089,29746,19673,26633,17749,21301,9396,19924,14555,15911,9423,19348,27891,25929,14841,7272,7595,23088,29187,28042,8797,21860,8080,23042,29176,26838,13783,9698],
                "text":"Net Sales",
            ...
            {
                "type":"bar",
                "values":[5342,4745,4731,3287,4417,3514,5644,4055,5470,5918,5628,3375,3137,3202,4080,5925,5540,5931,5913,5216,2595,3976,4932,2575,5856,4299,5716,5310,5256,3762,3802],
                "text":"COGs",
				"stacked":0
            },
            {
                "type":"bar",
                "values":[13185,4326,21805,26701,19544,21279,5505,13864,16768,19313,22458,16088,20828,16796,24828,3931,18561,20148,14497,12799,4429,12179,17938,9926,8775,17752,20116,6311,7352,7640,19650],
                "text":"Net Profit",
				"stacked":0,
...
"graphset":[
	...
	"graphset" : [
	{
		...
		"plot" : {
			...
			"value-box" : {
				"placement" : "in",
				//"font-color":"#000000", //Set Font Color of Value%
				"text" : "%v%"
			}
		},
		"series" : [
...
<script type="text/javascript">
	...
	<style type="text/css">
		...
		#tabsH { position:absolute; height:250px; top:355px; }
		#tabsTABLE { position:absolute; height:250px; top:355px; }
