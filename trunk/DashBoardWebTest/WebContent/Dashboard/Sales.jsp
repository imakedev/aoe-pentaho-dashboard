...
<html>
  <head>
	...
	<script type="text/javascript">
		...
		var urlP = '<%=request.getContextPath()%>/Dashboard/Sales.jsp'; // URL Page.
		var sb = <%=sb%>;
		function getSumBy(value)
		{
			sb = value;
			switch(sb){
				case '1' : urlP = '<%=request.getContextPath()%>/Dashboard/SalesYTD.jsp';
					break;
			}
		}
	...
	var bar1 = {
		...
		"graphset" : [
		{
			"type" : "bar",
			"scale-x":{
				"values":["ยอดขายปีนี้เทียบกับยอดขายปีที่แล้ว"],
				"guide":{
					"line-width": 1,
					"alpha": 1
				},
		...
		,
		{
			"type" : "bar",
			"scale-x":{
				"values":["ยอดขายปีนี้เทียบกับ Budget"],"line-color": "#8B8B7A",
				"guide":{
					"line-width": 1,
					"alpha": 1
				},
		...
		,
		{
			"type" : "bar",
			"scale-x":{
				"values":["สินค้าหมดอายุเทียบยอดขาย"],
				"guide":{
					"line-width": 1,
					"alpha": 1
				},
...
<!--+++++++++++++++++++++++++ Parameter +++++++++++++++++++++++++-->
	...
	<div style="position:absolute; left:250px; top:20px;"><font size="3"> สรุปตาม : </font>
		<select name="SumBy" onChange="getSumBy(this.value);">
			<option value="1"<%if(sb.equals("1")) out.print(" selected=\"selected\"");%>>YTD</option>
			<option value="2"<%if(sb.equals("2")) out.print(" selected=\"selected\"");%>>QTD</option>
			<option value="3"<%if(sb.equals("3")) out.print(" selected=\"selected\"");%>>MTD</option>
		</select> 
	</div>
		...
		<td>
			<table id="tabs-chart1">
				...
				<tr><td align="center"><br>
					<img src="<%=request.getContextPath()%>/Dashboard/images/legend_Sales.jpg" height="27" />
				</td></tr>
			</table>
		</td>
		</tr></table>
...
<!--+++++++++++++++++++++++++ Tab 2_2 +++++++++++++++++++++++++-->
	...
	<tr><td>
		...
		<table id="tabs-param2">
			...
			<tr><td>
			<select multiple size="6" style="width:190px;">
