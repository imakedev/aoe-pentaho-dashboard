...
<!-- Parameter -->
	...
	<!--          Drop Down List             -->
	<div style="position:absolute; left:300px; top:20px; color:#000000;"><font size="3"> สรุปตาม: </font>
	...
	<div style="position:absolute; left:650px; top:21px;">
  ...
  <table id=tabs-ratio width=100>
	<tr>
	  <td>
		<!-- Table Data -->
		<ul>
		  <li><a href="#tabs">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Financial Indicator&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></li>
		</ul>
