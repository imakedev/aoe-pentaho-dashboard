...
public class SalesTrendDTO implements Serializable {
	...
	private String netSalesAmtThis;
	...
	public String getNetSalesAmtThis() {
		return netSalesAmtThis;
	}
	public void setNetSalesAmtThis(String netSalesAmtThis) {
		this.netSalesAmtThis = netSalesAmtThis;
	}
