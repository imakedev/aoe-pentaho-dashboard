...
/**
 * The persistent class for the perspectiveresultthreshold database table.
 * 
 */
@Entity
@Table(name="perspectiveresultthreshold")
public class Perspectiveresultthreshold implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private PerspectiveresultthresholdPK id;
    ...
    public Perspectiveresultthreshold() {
    }

	public PerspectiveresultthresholdPK getId() {
		return this.id;
	}

	public void setId(PerspectiveresultthresholdPK id) {
		this.id = id;
	}
